...
var LinkList = React.createClass({
    ...
    render: function render() {
        var linkNodes = this.props.data.map(function (link) {
            return React.createElement(Link, { link: link.link });
        });
        return React.createElement(
            'div',
            { className: 'linkList' },
...
var LinkForm = React.createClass({
    ...
    render: function render() {
        return React.createElement(
            'form',
            { method: 'post', className: 'linkForm', onSubmit: this.handleSubmit },
            React.createElement('input', { type: 'text', placeholder: 'www.enterlinkhere.com', ref: 'link' }),
