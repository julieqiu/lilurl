...
var LinkBox = React.createClass({
    ...
    setCookies: function setCookies(data) {
...
var Link = React.createClass({
    ...
    shortLink: function shortLink(link) {
        if (link.length > 60) {
    ...
    fullLilurl: function fullLilurl(code) {
    ...
    render: function render() {
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    'a',
                    { href: this.fullLilurl(this.props.code), className: 'linkUrl' },
...
var LinkList = React.createClass({
    ...
    render: function render() {
        ...
        if (cookieLinks) {
            var recentHeader = React.createElement(
                'h2',
...
React.render(React.createElement(LinkBox, { url: 'postdetails/' }), document.getElementById('content'));

},{"jquery":3,"js-cookie":4,"react":159}],2:[function(require,module,exports){
